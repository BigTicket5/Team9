...
//		us3.CouplesWithCommonAncestor();
		...
		System.out.println("Number of Husband in this family is " +us4.NumberOfHusband(filepath));
		System.out.println("Number of Couples in this family is " +us4.NumberOfCouples(filepath));
		Sprint4 sp4 = new Sprint4();
		System.out.println("The first name appeared in this family are" );
		sp4.ListFirstName(filepath);
		System.out.println("");
		System.out.println("The last name appeared in this family are");
		sp4.ListLastName(filepath);
